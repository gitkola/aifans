...
const ThemeSwitcher: React.FC = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="absolute top-2 right-2 px-2 py-2 justify-center align-middle rounded-md bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 transition-all duration-300 ease-in-out"
    >
      {theme === "light" ? (
        <svg
          width="24px"
